...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'output_url' => 'sometimes|string|stream_url|max:2048',
            'output_protocol' => 'sometimes|in:rtmp,rtmps,srt,hls_push,mpeg_ts_udp,mpeg_ts_tcp,rtp,icecast,shoutcast,file',
            'trigger' => 'sometimes|in:always,live_only,fallback_only,manual',
